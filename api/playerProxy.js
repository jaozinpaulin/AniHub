module.exports = async function handler(req, res) {
    ...
    // Garante que não haja barras duplicadas no final da base
    const baseUrl = rawBaseUrl.replace(/\/+$/, '');

    // Montamos a URL incluindo o /#/video/
    ...
    try {
        ...
        return res.status(500).json({ error: `Erro ao buscar o conteúdo do player: ${error.message}` });
    }
};